...
export default function LoginPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1a1a1a] p-6 text-center transition-colors duration-300">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">Set a valid Clerk publishable key to enable sign-in.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <SignIn path="/login" routing="path" signUpUrl="/signup" fallbackRedirectUrl="/dashboard1" />
    </div>
  );
}
